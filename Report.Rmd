...
This finished assignment was described in multiple parts. Answers to all the questions were detailed below. This is a single R markdown document that can be processed by knitr and be transformed into an HTML file.
